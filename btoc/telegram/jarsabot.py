...
# # (c) <2016> <Jarsa Sistemas S.A de C.V>
...
#         #                 'openerp.addons.' + m + '.telegram.handlers.'
#         #                 'TelegramBotHandlers')
#         #     TelegramBotHandlers(BOT).handle()
...
#     telegram_apikey = config.get('telegram_apikey', 0)
